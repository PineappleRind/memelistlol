...
var memes = [{
    ...
    "name": "At the business centre, I'm Mike Eppel",
    "description": "This meme stemmed from a 680 News business anchorman saying the phrase \"At the business centre, i'm Mike Eppel\" at the end of his Business report.",
    ...
    "name": "Bistro Moustachio",
    "description": "Margarita! Inspired by the way Meme Creator 1 said the word \"Margarita\", Meme Creators 1 and 3 made a restaraunt called <cursive>Bistro Moustachio</cursive>",
    "achievements": ["Mojito", "Bourbon", "Margarita"],
    "reqs": [2, 5, 10]
}, {
    "name": "Body Types",
    ...
    "achievements": ["Column", "Wide Column", "Wider Column"],
    "reqs": [2, 5, 10]
}, {
    "name": "BOYBOY",
    ...
    "achievements": ["Chea", "Cheapou", "Cheapoulearni"],
    "reqs": [2, 5, 10]
}, {
    "name": "Canala! Canala!",
    ...
    "name": "Lisa Bee",
    "description": "When the Meme Creator's aunt bought a new computer, she set the account name as Lisa Bee. This caught on with the Meme Creators, and Lisa Bee ended up being a Varsity Cheerleader and Ballet Dancer! They looked up Lisa Bee, and found there was a Lisa Bee that reviewed <b>WIGS!</b>",
    ...
    "description": "The Meme Creators' Filipino housekeeper once wanted some New York Cheesecake. She called her friend and they both drove many hours to New York and got some nice New York Cheesecake!",
...
var saveData = {
    "achievementsList": [],
    "search": {
        "achievements": ["Just looking", "Searching", "Airport guard", "The FBI"],
        "reqs": [1, 10, 25, 50]
    },
    "memes": [{
        "name": "Andrew Chester",
