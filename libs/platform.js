(function() {
    ...
    var e = {
        ...
        r = e[typeof module] && module && !module.nodeType && module,
        n = i && r && "object" == typeof global && global;
    !n || n.global !== n && n.window !== n && n.self !== n || (t = n);
    ...
    var h = function e(i) {
        var r = t,
            n = i && "object" == typeof i && "String" != u(i);
        n && (r = i, i = null);
        var o = r.navigator || {},
            l = o.userAgent || "";
        i || (i = l);
        var s, p, h, m, g, O = n ? !!o.likeChrome : /\bChrome\b/.test(i) && !/internal|\n/i.test(b.toString()),
            y = n ? "Object" : "ScriptBridgingProxyObject",
            M = n ? "Object" : "Environment",
            E = n && r.java ? "JavaPackage" : u(r.java),
            w = n ? "Object" : "RuntimeObject",
            v = /\bJava/.test(E) && r.java,
            P = v && u(r.environment) == M,
            C = v ? "a" : "α",
            B = v ? "b" : "β",
            W = r.document || {},
            k = r.operamini || r.opera,
            R = a.test(R = n && k ? k["[[Class]]"] : u(k)) ? R : k = null,
            A = i,
            I = [],
            F = null,
            T = i == l,
            G = T && k && "function" == typeof k.version && k.version(),
            $ = S([{
                label: "EdgeHTML",
                pattern: "Edge"
            }, "Trident", {
                ...
                return e || RegExp("\\b" + (t.pattern || f(t)) + "\\b", "i").exec(i) && (t.label || t)
            }),
            j = function(e) {
            ...
            K = function(e) {
                return S(e, function(e, t, r) {
                    return e || (t[X] || t[/^[a-z]+(?: +[a-z]+\b)*/i.exec(X)] || RegExp("\\b" + f(r) + "(?:\\b|\\w*\\d)", "i").exec(i)) && r
                })
            }({
                Apple: {
                    iPad: 1,
            ...
            N = function(e) {
                return S(e, function(e, t) {
                    var r = t.pattern || f(t);
                    return !e && (e = RegExp("\\b" + r + "(?:/[\\d.]+|[ \\w.]*)", "i").exec(i)) && (e = function(e, t, i) {
                        var r = {
                            "10.0": "10",
                        ...
                        return t && i && /^Win/i.test(e) && !/^Windows Phone /i.test(e) && (r = r[/[\d.]+$/.exec(e)]) && (e = "Windows " + r), e = String(e), t && i && (e = e.replace(RegExp(t, "i"), i)), e = c(e.replace(/ ce$/i, " CE").replace(/\bhpw/i, "web").replace(/\bMacintosh\b/, "Mac OS").replace(/_PowerPC\b/i, " OS").replace(/\b(OS X) [^ \d]+/i, "$1").replace(/\bMac (OS X)\b/, "$1").replace(/\/(\d)/, " $1").replace(/_/g, ".").replace(/(?: BePC|[ .]*fc[ \d.]+)$/i, "").replace(/\bx86\.64\b/gi, "x86_64").replace(/\b(Windows Phone) OS\b/, "$1").replace(/\b(Chrome OS \w+) [\d.]+\b/, "$1").split(" on ")[0])
                    }(e, r, t.label || t)), e
                })
        ...
        function V(e) {
            return S(e, function(e, t) {
                var r = t.pattern || f(t);
                return !e && (e = RegExp("\\b" + r + " *\\d+[.\\w_]*", "i").exec(i) || RegExp("\\b" + r + " *\\w+-[\\w]*", "i").exec(i) || RegExp("\\b" + r + "(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)", "i").exec(i)) && ((e = String(t.label && !RegExp(r, "i").test(t.label) ? t.label : e).split("/"))[1] && !/[\d.]+/.test(e[0]) && (e[0] += " " + e[1]), t = t.label || t, e = c(e[0].replace(RegExp(r, "i"), t).replace(RegExp("; *(?:" + t + "[_-])?", "i"), " ").replace(RegExp("(" + t + ")[-_.]?(\\w)", "i"), "$1 $2"))), e
            })
        }
        ...
        }, H.version && I.unshift(G), H.name && I.unshift(j), N && j && (N != String(N).split(" ")[0] || N != j.split(" ")[0] && !X) && I.push(X ? "(" + N + ")" : "on " + N), I.length && (H.description = I.join(" ")), H
    }();
    "function" == typeof define && "object" == typeof define.amd && define.amd ? (t.platform = h, define(function() {
        return h
    })) : i && r ? d(h, function(e, t) {
        i[t] = e
    }) : t.platform = h
}).call(this);

document.getElementById('loadText').innerHTML = 'Loading data.js...'